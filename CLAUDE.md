...
- scripts/build_knowledge_base.py — rerun after editing knowledge_base/*.md to refresh data/chroma/
...
- data/chroma/ is generated by scripts/build_knowledge_base.py and gitignored —
  never commit it; rerun the build script after editing knowledge_base/*.md.
